    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-h3 font-bold text-neutral-900">App Versions</h1>
                    <p className="text-body-lg text-neutral-600">Manage mobile application versions</p>
                </div>
                <button
                    onClick={() => setIsAddModalOpen(true)}
                    className="flex items-center space-x-2 rounded-lg bg-primary-500 px-4 py-2 font-semibold text-white shadow-sm hover:bg-primary-600 transition-all"
                >
